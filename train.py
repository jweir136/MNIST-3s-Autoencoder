...
from MNIST3sDataset import *

ROOT_DIR = "../../datasets/mnist-jpg"
TRAINING_DIR = os.path.join(ROOT_DIR, "trainingSet", "trainingSet", "3")
...
trainfolder = MNIST3sDataset(TRAINING_DIR, trans)
...
for epoch in range(50):
  for x in tqdm(trainloader):
    ...
    loss = loss_function(x_pred, x, mu, logvar, epoch+1)
